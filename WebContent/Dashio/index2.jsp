  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        text: 'Hover me to enable the Close Button. You can hide the left sidebar clicking on the button next to the logo. Developed by <a href="${path}/Dashio/http://alvarez.is" target="_blank" style="color:#4ECDC4">Alvarez.is</a>.',
