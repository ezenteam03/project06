  ...
  <section id="container">
            ...
            <section class="panel">
              ...
              <div class="panel-body ">
                <div class="mail-header row">
                  ...
                  <div class="col-md-4">
                    <div class="compose-btn pull-right">
                      <a href="${path}/Dashio/mail_compose.jsp" class="btn btn-sm btn-theme"><i class="fa fa-reply"></i> Reply</a>
                ...
                <div class="mail-sender">
                  <div class="row">
                    <div class="col-md-8">
                      <img src="${path}/Dashio/img/ui-zac.jpg" alt="">
                ...
                <div class="attachment-mail">
                  <p>
                    ...
                    <a href="${path}/Dashio/#">Download all attachments</a> |
                    <a href="${path}/Dashio/#">View all images</a>
                  </p>
                  <ul>
                    <li>
                      <a class="atch-thumb" href="${path}/Dashio/#">
                        <img src="${path}/Dashio/img/instagram.jpg">
                        </a>
                      <a class="name" href="${path}/Dashio/#">
                        IMG_001.jpg
                        <span>20KB</span>
                        </a>
                      <div class="links">
                        <a href="${path}/Dashio/#">View</a> -
                        <a href="${path}/Dashio/#">Download</a>
                      </div>
                    </li>
                    <li>
                      <a class="atch-thumb" href="${path}/Dashio/#">
                        <img src="${path}/Dashio/img/weather.jpg">
                        </a>
                      <a class="name" href="${path}/Dashio/#">
                        IMG_001.jpg
                        <span>20KB</span>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="${path}/Dashio/mail_view.jsp#" class="go-top">
