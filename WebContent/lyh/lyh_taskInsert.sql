...
INSERT INTO PMSTASK values(pmstask_seq.nextval, 1002, 1046, '대관신청(대관료/티켓수익배분)(웹)','- 대관신청-대관료/ 티켓수익배분 선택(100%)  ',null,'2020/05/21','2020/06/01', 0,NULL,NULL,21,10000024);
INSERT INTO PMSTASK values(pmstask_seq.nextval, 1002, 1046, '대관신청(리스트/약관)(앱)','- 소극장 대관 현황 리스트(50%) &#10;- 대관신청 - 대관신청 form / 대관신청 약관(50%) &#10;',null,'2020/05/08','2020/05/20', 0,NULL,NULL,21,10000024);
INSERT INTO PMSTASK values(pmstask_seq.nextval, 1002, 1046, '대관신청(대관료/티켓수익배분)(앱)','- 대관신청-대관료/ 티켓수익배분 선택(100%)  ',null,'2020/05/21','2020/06/01', 0,NULL,NULL,21,10000024);
