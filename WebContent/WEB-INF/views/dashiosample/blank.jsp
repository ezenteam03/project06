...
<body>
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="${path}/Dashio/blank.jsp">Blank Page</a></li>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="${path}/Dashio/blank.jsp#" class="go-top">
  ...
  <script src="${path}/Dashio/lib/jquery.ui.touch-punch.min.js"></script>
