...
<body>
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="${path}/Dashio/inline_editor.jsp">Inline Editor</a></li>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="${path}/Dashio/inline_editor.jsp#" class="go-top">
  ...
  <script src="${path}/Dashio/lib/ckeditor/ckeditor.js"></script>
