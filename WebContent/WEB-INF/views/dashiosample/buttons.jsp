  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="${path}/Dashio/buttons.jsp">Buttons</a></li>
              ...
              <div class="btn-group">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="${path}/Dashio/#">Dropdown link</a></li>
                    <li><a href="${path}/Dashio/#">Dropdown link</a></li>
                  </ul>
                </div>
              </div>
            ...
            <div class="showback">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="${path}/Dashio/#">Action</a></li>
                  <li><a href="${path}/Dashio/#">Another action</a></li>
                  <li><a href="${path}/Dashio/#">Something else here</a></li>
                  <li class="divider"></li>
                  <li><a href="${path}/Dashio/#">Separated link</a></li>
                </ul>
              </div>
            </div>
            <!-- /showback -->
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="${path}/Dashio/buttons.jsp#" class="go-top">
