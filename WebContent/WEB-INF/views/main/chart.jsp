			...
			$.ajax({
				...
				success:function(data){
				    ...
				    $.each(clist,function(idx, chart){
				    	console.log(chart.tname);
				    	chart+="{name: "+chart.tname;
				    	chart+=",id: "+chart.tno;
				    	chart+=",parent: "+chart.refno;
				    	chart+=",start: today + ("+chart.sdate;
				    	chart+=" * day),end: today + ("+chart.edate;
				    	chart+=" * day),completed: { amount : "+chart.prog;
				    	chart+="},owner: "+chart.name+"},";
					});
				    console.log(chart);
				},
				error:function(err){
