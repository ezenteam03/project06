						...
						<div class="col-md-12 mt">
							<div id="goIS" class="content-panel">
									...
									<div
										...
										<ul class="pagination justify-content-center"
											...
											<li class="page-item"><a class="page-link"
												href="javascript:goPage(${msch.startBlock-1});">Previous</a></li>
											<c:forEach var="cnt" begin="${msch.startBlock }"
												end="${msch.endBlock}">
											...
											<li class="page-item"><a class="page-link"
												href="javascript:goPage(${(msch.endBlock==msch.pageCount)?msch.endBlock:msch.endBlock+1});">Next</a></li>
										</ul>
									</div>
									<br>
								...
								<button id="regBtn" type="button" class="btn btn-theme"
									v-if="mdiv!==2&&mdiv!==3" style="margin-left: 90%;">
