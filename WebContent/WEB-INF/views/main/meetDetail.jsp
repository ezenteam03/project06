					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="input-group mb-3">
							...
							<input name="topic" class="form-control"
								style="background: white;" value="${meet.topic}"
						...
						<div class="input-group mb-3">
							...
							<input name="writer" class="form-control" readonly="readonly"
								style="background: white;" value="${meet.writer}" placeholder="" />
						</div>
						...
						<div class="input-group mb-3">
							...
							<input name="people" class="form-control"
								style="background: white;" value="${meet.people}" />
						</div>
						...
						<div class="input-group mb-3">
							...
							<input name="loc" class="form-control" readonly="readonly"
								style="background: white;" value="${meet.loc}" />
						</div>
						...
						<div class="input-group mb-3">
							...
							<input name="mnno" class="form-control" readonly="readonly"
								style="background: white;" value="${meet.mnno}" />
						</div>
						...
						<div class="input-group mb-3">
							...
							<input class="form-control" readonly="readonly"
								style="background: white;" value="${meet.views}" />
						</div>

						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="bg-warning text-white input-group-text">회의일시
								</span>
							</div>
							<input class="form-control" readonly="readonly"
						...
						<div class="input-group mb-3">
							...
							<textarea name="decision" rows="5" class="form-control"
						...
						<div class="input-group mb-3">
							...
							<textarea name="etc" rows="5" class="form-control"
								placeholder="없음">${meet.etc}</textarea>
						</div>

						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="bg-success text-white input-group-text">첨부
									파일</span>
							</div>
						...
						<br>
						<div id="meetRe" v-if="mdiv!==2&&mdiv!==3"
